...
<body>
    ...
    <section class="home_banner relative">
        ...
        <img class="face-img img-fluid" src="{{asset('frontend/img/banner/home-banner.png')}}" alt="">
    </section>
    <!--================ End banner section =================-->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="single_dish col-lg-4 col-md-6 text-center">
                    <div class="thumb">
                        <img class="img-fluid" src="{{asset('frontend/img/dish/d1.jpg')}}" alt="">
                    </div>
                ...
                <div class="single_dish col-lg-4 col-md-6 text-center">
                    <div class="thumb">
                        <img class="img-fluid" src="{{asset('frontend/img/dish/d2.jpg')}}" alt="">
                    </div>
                ...
                <div class="single_dish col-lg-4 col-md-6 text-center">
                    <div class="thumb">
                        <img class="img-fluid" src="{{asset('frontend/img/dish/d3.jpg')}}" alt="">
                    </div>
    ...
    <section class="gallery_area">
        <div class="container">
            ...
            <div class="row" id="lightgallery">
                <div class="col-lg-7 all-image" data-src="{{asset('frontend/img/gallery/g1.jpg')}}">
                    <div class="single-gallery">
                        <div class="overlay"></div>
                        <img class="img-fluid w-100" src="{{asset('frontend/img/gallery/g1.jpg')}}" alt="">
                        <div class="content">
                ...
                <div class="col-lg-5 all-image" data-src="{{asset('frontend/img/gallery/g2.jpg')}}">
                    <div class="single-gallery">
                        <div class="overlay"></div>
                        <img class="img-fluid w-100" src="{{asset('frontend/img/gallery/g2.jpg')}}" alt="">
                        <div class="content">
                            <i class="lnr lnr-picture"></i>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 all-image" data-src="{{asset('frontend/img/gallery/g3.jpg')}}">
                    <div class="single-gallery">
                        <div class="overlay"></div>
                        <img class="img-fluid w-100" src="{{asset('frontend/img/gallery/g3.jpg')}}" alt="">
                        <div class="content">
                            <i class="lnr lnr-picture"></i>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 all-image" data-src="{{asset('frontend/img/gallery/g4.jpg')}}.jpg">
                    <div class="single-gallery">
                        <div class="overlay"></div>
                        <img class="img-fluid w-100" src="{{asset('frontend/img/gallery/g4.jpg')}}" alt="">
                        <div class="content">
                            <i class="lnr lnr-picture"></i>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 all-image" data-src="{{asset('frontend/img/gallery/g5.jpg')}}">
                    <div class="single-gallery">
                        <div class="overlay"></div>
                        <img class="img-fluid w-100" src="{{asset('frontend/img/gallery/g5.jpg')}}" alt="">
                        <div class="content">
                            <i class="lnr lnr-picture"></i>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 all-image" data-src="{{asset('frontend/img/gallery/g6.jpg')}}">
                    <div class="single-gallery">
                        <div class="overlay"></div>
                        <img class="img-fluid w-100" src="{{asset('frontend/img/gallery/g6.jpg')}}" alt="">
                        <div class="content">
                            <i class="lnr lnr-picture"></i>
                        </div>
                    </div>
                ...
                <div class="col-lg-7 all-image" data-src="{{asset('frontend/img/gallery/g7.jpg')}}">
                    <div class="single-gallery">
                        <div class="overlay"></div>
                        <img class="img-fluid w-100" src="{{asset('frontend/img/gallery/g7.jpg')}}" alt="">
                        <div class="content">
                            <i class="lnr lnr-picture"></i>
                        </div>
                    </div>
