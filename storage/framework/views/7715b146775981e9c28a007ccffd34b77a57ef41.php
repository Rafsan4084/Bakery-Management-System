...
<head>
	...
	<link rel="icon" href="<?php echo e(asset('frontend/img/favicon.png')); ?>" type="image/png">
	...
	<link rel="stylesheet" href="<?php echo e(asset('frontend/vendors/lightbox/simpleLightbox.css')); ?>">
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="index.html">
						<img class="logo-1" src="<?php echo e(asset('frontend/img/logo.png')); ?>" alt="">
						<img class="logo-2" src="<?php echo e(asset('frontend/img/logo-2.png')); ?>" alt="">
					</a>
	...
	<section class="about_story_area section_gap">
		<div class="container">
			<div class="row story_inner">
				...
				<div class="col-lg-6">
					<div class="story_img">
						<img class="img-fluid" src="<?php echo e(asset('frontend/img/story/story-1.jpg')); ?>" alt="">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="testi_slider owl-carousel">
				<div class="item">
					<div class="row">
						<div class="col-lg-4">
							<img src="<?php echo e(asset('frontend/img/testimonials/testi-1.jpg')); ?>" alt="">
						</div>
						<div class="col-lg-8">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<script src="<?php echo e(asset('frontend/vendors/lightbox/simpleLightbox.min.js')); ?>"></script>
